        ...
        <div className='bg-white px-1 py-8 flex flex-col gap-10 sm:flex-row'>
            <div className='text-white  flex flex-col gap-8 sm:w-1/3'>
                <div className='bg-black shadow-lg shadow-black rounded-xl'>
                    <img src={`https://images.pexels.com/photos/826114/pexels-photo-826114.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1`} alt=""/>
            ...
            <div className=' bg-black text-white h-full rounded-xl shadow-xl shadow-black order-last sm:w-2/3 sm:order-first'>
                <img src={`https://images.pexels.com/photos/2820906/pexels-photo-2820906.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1`} alt="" />
                <div className='p-4'>
